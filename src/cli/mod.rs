            ...
            if !report_differences.is_empty() {
                for entry in report_differences.iter() {
                    match entry {
                        ...
                        Addition { path, thing: ColumnPrivilege(grantor, grantee) } => println!("{}: privilege '{}' -> '{}' added", CLI::render_path(path), grantor, grantee),
                        ...
                        Addition { path, thing: RoutinePrivilege(grantor, grantee) } => println!("{}: privilege '{}' -> '{}' added", CLI::render_path(path), grantor, grantee),
                        ...
                        Addition { path, thing: TablePrivilege(grantor, grantee) } => println!("{}: privilege '{}' -> '{}' added", CLI::render_path(path), grantor, grantee),
                        ...
                        Removal { path, thing: ColumnPrivilege(grantor, grantee) } => println!("{}: privilege '{}' -> '{}' removed", CLI::render_path(path), grantor, grantee),
                        ...
                        Removal { path, thing: RoutinePrivilege(grantor, grantee) } => println!("{}: privilege '{}' -> '{}' removed", CLI::render_path(path), grantor, grantee),
                        ...
                        Removal { path, thing: TablePrivilege(grantor, grantee) } => println!("{}: privilege '{}' -> '{}' removed", CLI::render_path(path), grantor, grantee),
